    ...
    <div className="mx-auto flex max-w-md justify-around px-1 py-1.5">
      {mainItems.map((item) => (
        <Link
          ...
          href={item.href}
          onClick={() => setIsMoreOpen(false)}
          className="flex min-h-14 min-w-0 flex-1 touch-manipulation flex-col items-center justify-center rounded-xl px-1 py-1 text-xs text-gray-700 transition-colors hover:bg-gray-50 active:bg-gray-100"
        >
