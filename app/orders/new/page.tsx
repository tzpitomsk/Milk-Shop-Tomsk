...
return ( <main className="min-h-screen bg-slate-100 p-4"> <div className="mx-auto max-w-md"> <h1 className="mb-6 text-3xl font-bold text-green-700">
🛒 Новый заказ </h1>
...
return (
<Suspense
fallback={ <div className="p-5">
Загрузка... </div>
}
> <NewOrderPage /> </Suspense>
);
}
