            ...
            >
              ...
              <div className="p-5">
                <div className="flex items-start justify-between gap-4">
                  ...
                  {/* STOCK */}
                  <div
                    className={`shrink-0 rounded-2xl border px-4 py-3 text-center ${stockClasses.box}`}
                  >
                    <div
                      className={`text-2xl font-bold ${stockClasses.number}`}
                    >
                      {product.stock}
                    </div>
                    ...
                    <div
                      className={`mt-1 text-xs font-bold ${stockClasses.label}`}
                    >
                      {getStockLabel(
                        product.stock
                      )}
                ...
                <div className="mt-5 grid grid-cols-2 gap-2 sm:grid-cols-4">
                  <Link
                    ...
                    className="rounded-xl border border-blue-200 bg-blue-50 px-3 py-3 text-center text-sm font-semibold text-blue-700 transition hover:bg-blue-100"
                  >
                    ✏️ Изменить
                  </Link>
                  ...
                  <Link
                    ...
                    className="rounded-xl border border-purple-200 bg-purple-50 px-3 py-3 text-center text-sm font-semibold text-purple-700 transition hover:bg-purple-100"
                  >
                    📜 История
                  </Link>
                  ...
                  <Link
                    ...
                    className="rounded-xl border border-green-200 bg-green-50 px-3 py-3 text-center text-sm font-semibold text-green-700 transition hover:bg-green-100"
                  >
                    🚚 Поставка
                  </Link>
                  ...
                  {canSell ? (
                    <Link
                      ...
                      className="rounded-xl border border-green-700 bg-green-700 px-3 py-3 text-center text-sm font-semibold text-white transition hover:bg-green-800"
                    >
                      🛒 Продать
                    </Link>
                  ) : (
                    <button
                      ...
                      className="cursor-not-allowed rounded-xl border border-slate-200 bg-slate-100 px-3 py-3 text-center text-sm font-semibold text-slate-400"
                    >
                      🛒 Продать
                    </button>
                  )}
                ...
                <button
                  ...
                  disabled={isDeleting}
                  className="mt-3 w-full rounded-xl border border-red-200 bg-white py-2.5 text-sm font-semibold text-red-600 transition hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {isDeleting
                    ? "⏳ Удаление..."
                    : "🗑️ Удалить товар"}
